...
const TOOLS_DB: Record<string, { label: string, url: string, icon: any, badge?: string }> = {
    ...
    amazon_book: { label: '名著・参考書 (Amazon)', url: 'https://amzn.to/4bs6BhD', icon: Book, badge: '学習' },
    amazon_gadget: { label: '集中ガジェット (Amazon)', url: 'https://amzn.to/4bs6BhD', icon: Headphones, badge: '環境' },
    amazon_workspace: { label: 'デスク環境 (Amazon)', url: 'https://amzn.to/4bs6BhD', icon: Monitor, badge: '環境' },
}
